...
adb shell setprop debug.mtk_tflite.vlog
 
adb shell setprop debug.nn.vlog
adb shell setprop debug.neuropilot.vlog
 
adb root
 
adb shell setprop persist.vendor.apuware.debug.utilslog
adb shell setprop persist.vendor.apuware.debug.xrplog
adb shell setprop persist.vendor.apuware.debug.apusyslog
 
adb root
 
adb shell setprop debug.neuron.adapter.AdapterSetDebugLevel
 
adb shell setprop debug.neuron.runtime.Verbose
adb shell setprop debug.neuron.runtime.DumpVerbose
